...
Assert-True ([int]$d.test_total                                -eq 580)  "dotnet test_total == 580"
Assert-True ([int]$d.core_tests -eq 204)  "dotnet core_tests == 204"
Assert-True ([int]$d.cli_tests                                 -eq 376)  "dotnet cli_tests == 376"
