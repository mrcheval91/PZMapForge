...
<#
.SYNOPSIS
    Validates .local/mapforge/proof-packet.json against the v0.48 proof-packet contract.
...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.48') `
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1061) "total_expected_assertions == 1061"
