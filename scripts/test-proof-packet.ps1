...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.69') `
    "schema == 'pzmapforge.proof-packet.v0.69' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1584) "total_expected_assertions == 1584"
