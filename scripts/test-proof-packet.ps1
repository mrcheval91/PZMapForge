...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.59') `
    "schema == 'pzmapforge.proof-packet.v0.59' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1296) "total_expected_assertions == 1296"
