...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.67') `
    "schema == 'pzmapforge.proof-packet.v0.67' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1520) "total_expected_assertions == 1520"
