...
Assert-True ($null -ne $p.validation_summary.PSObject.Properties['map37e_differential_control_test_packet_tests']) "Field 'map37e_differential_control_test_packet_tests' present"
Assert-True ([int]$p.validation_summary.map37e_differential_control_test_packet_tests -eq 60) "map37e_differential_control_test_packet_tests == 60"
Assert-True ($null -ne $p.validation_summary.PSObject.Properties['map37d_human_runtime_load_test_packet_tests']) "Field 'map37d_human_runtime_load_test_packet_tests' present"
Assert-True ([int]$p.validation_summary.map37d_human_runtime_load_test_packet_tests -eq 29) "map37d_human_runtime_load_test_packet_tests == 29"
Assert-True ($null -ne $p.validation_summary.PSObject.Properties['map37c_chunkdata_staged_packet_tests']) "Field 'map37c_chunkdata_staged_packet_tests' present"
Assert-True ([int]$p.validation_summary.map37c_chunkdata_staged_packet_tests    -eq 20)  "map37c_chunkdata_staged_packet_tests == 20"
...
Assert-True ([int]$p.validation_summary.map9b_canary_writer_unblock_packet_tests           -eq 37) "map9b_canary_writer_unblock_packet_tests == 37"
Assert-True ($null -ne $p.validation_summary.PSObject.Properties['map9a_bootstrap_canary_packet_tests']) "Field 'map9a_bootstrap_canary_packet_tests' present"
Assert-True ([int]$p.validation_summary.map9a_bootstrap_canary_packet_tests                -eq 26) "map9a_bootstrap_canary_packet_tests == 26"
Assert-True ([int]$p.validation_summary.map8z_controlled_igmb_install_packet_tests       -eq 24) "map8z_controlled_igmb_install_packet_tests == 24"
Assert-True ([int]$p.validation_summary.map8y_experimental_igmb_writer_tests              -eq 30) "map8y_experimental_igmb_writer_tests == 30"
Assert-True ([int]$p.validation_summary.map8y_experimental_igmb_writer_packet_tests       -eq 20) "map8y_experimental_igmb_writer_packet_tests == 20"
Assert-True ([int]$p.validation_summary.map8x_real_transition_structure_result_tests      -eq 20) "map8x_real_transition_structure_result_tests == 20"
Assert-True ([int]$p.validation_summary.map8w_igmb_transition_structure_inspector_tests   -eq 24) "map8w_igmb_transition_structure_inspector_tests == 24"
Assert-True ([int]$p.validation_summary.map8w_igmb_transition_structure_result_tests      -eq 20) "map8w_igmb_transition_structure_result_tests == 20"
Assert-True ([int]$p.validation_summary.map8v_real_first_non_ff_transition_result_tests   -eq 20) "map8v_real_first_non_ff_transition_result_tests == 20"
Assert-True ([int]$p.validation_summary.map8u_first_non_ff_transition_inspector_tests     -eq 27) "map8u_first_non_ff_transition_inspector_tests == 27"
Assert-True ([int]$p.validation_summary.map8u_first_non_ff_transition_result_tests        -eq 20) "map8u_first_non_ff_transition_result_tests == 20"
Assert-True ($null -ne $p.validation_summary.PSObject.Properties['map8t_real_cell_boundary_result_tests']) "Field 'map8t_real_cell_boundary_result_tests' present"
Assert-True ([int]$p.validation_summary.map8t_real_cell_boundary_result_tests            -eq 20) "map8t_real_cell_boundary_result_tests == 20"
Assert-True ([int]$p.validation_summary.map8s_igmb_cell_boundary_inspector_tests         -eq 20) "map8s_igmb_cell_boundary_inspector_tests == 20"
Assert-True ([int]$p.validation_summary.map8s_cell_boundary_result_tests                 -eq 20) "map8s_cell_boundary_result_tests == 20"
Assert-True ($null -ne $p.validation_summary.PSObject.Properties['map8r_real_igmb_structure_result_tests']) "Field 'map8r_real_igmb_structure_result_tests' present"
Assert-True ([int]$p.validation_summary.map8r_real_igmb_structure_result_tests           -eq 20) "map8r_real_igmb_structure_result_tests == 20"
...
Assert-True ([int]$p.validation_summary.map8q_igmb_structure_inspector_tests             -eq 24) "map8q_igmb_structure_inspector_tests == 24"
...
Assert-True ([int]$p.validation_summary.map8o_worldmap_bin_header_result_tests    -eq 20) "map8o_worldmap_bin_header_result_tests == 20"
Assert-True ([int]$p.validation_summary.map8n_worldmap_bin_presence_result_tests -eq 20) "map8n_worldmap_bin_presence_result_tests == 20"
Assert-True ([int]$p.validation_summary.map8m_worldmap_bin_presence_inspector_tests -eq 16) "map8m_worldmap_bin_presence_inspector_tests == 16"
Assert-True ([int]$p.validation_summary.map8l_worldmap_xml_runtime_result_tests -eq 20) "map8l_worldmap_xml_runtime_result_tests == 20"
...
Assert-True ([int]$p.validation_summary.map8f_lots_self_runtime_result_tests      -eq 20) "map8f_lots_self_runtime_result_tests == 20"
Assert-True ([int]$p.validation_summary.map8d_no_invalid_worldmap_bin_probe_tests -eq 20) "map8d_no_invalid_worldmap_bin_probe_tests == 20"
...
Assert-True ([int]$d.test_total                                -eq 652)  "dotnet test_total == 652"
Assert-True ([int]$d.core_tests -eq 240)  "dotnet core_tests == 240"
Assert-True ([int]$d.cli_tests                                 -eq 412)  "dotnet cli_tests == 412"
