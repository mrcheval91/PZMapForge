...
Assert-True ([int]$d.test_total                                -eq 640)  "dotnet test_total == 640"
Assert-True ([int]$d.core_tests -eq 234)  "dotnet core_tests == 234"
Assert-True ([int]$d.cli_tests                                 -eq 406)  "dotnet cli_tests == 406"
