...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.75') `
    "schema == 'pzmapforge.proof-packet.v0.75' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1798) "total_expected_assertions == 1798"
