...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.74') `
    "schema == 'pzmapforge.proof-packet.v0.74' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1773) "total_expected_assertions == 1773"
