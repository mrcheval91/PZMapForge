...
<#
.SYNOPSIS
    Validates .local/mapforge/proof-packet.json against the v0.47 proof-packet contract.
...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.47') `
    "schema == 'pzmapforge.proof-packet.v0.47' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1040) "total_expected_assertions == 1040"
