...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.57') `
    "schema == 'pzmapforge.proof-packet.v0.57' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1254) "total_expected_assertions == 1254"
