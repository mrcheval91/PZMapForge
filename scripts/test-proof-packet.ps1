...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.72') `
    "schema == 'pzmapforge.proof-packet.v0.72' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1700) "total_expected_assertions == 1700"
