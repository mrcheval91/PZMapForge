...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.73') `
    "schema == 'pzmapforge.proof-packet.v0.73' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1721) "total_expected_assertions == 1721"
