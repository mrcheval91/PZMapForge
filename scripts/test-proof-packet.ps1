...
<#
.SYNOPSIS
    Validates .local/mapforge/proof-packet.json against the v0.22 proof-packet contract.
...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.22') `
    "schema == 'pzmapforge.proof-packet.v0.22' (got '$($p.schema)')"
