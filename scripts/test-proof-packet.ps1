...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.80') `
    "schema == 'pzmapforge.proof-packet.v0.80' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1996) "total_expected_assertions == 1996"
