...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.68') `
    "schema == 'pzmapforge.proof-packet.v0.68' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1562) "total_expected_assertions == 1562"
