...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.64') `
    "schema == 'pzmapforge.proof-packet.v0.64' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.map8o_worldmap_bin_header_inspector_tests -eq 20) "map8o_worldmap_bin_header_inspector_tests == 20"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1432) "total_expected_assertions == 1432"
