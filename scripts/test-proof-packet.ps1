...
Assert-True ($p.schema -eq 'pzmapforge.proof-packet.v0.58') `
    "schema == 'pzmapforge.proof-packet.v0.58' (got '$($p.schema)')"
...
Assert-True ([int]$p.validation_summary.total_expected_assertions              -eq 1275) "total_expected_assertions == 1275"
