...
$dnCoreTests = 210   # PZMapForge.Core.Tests (MAP-36B: +6 bridge-plan tests)
$dnCliTests  = 382   # PZMapForge.Cli.Tests (MAP-36B: +6 bridge-plan tests)
$dnTotal     = 592   # = dotnet_validation_summary.test_total (MAP-36B: +12)
