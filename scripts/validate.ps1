...
.SYNOPSIS
    ...
    Final output reports the complete PowerShell validation lane total (2025)
    and the .NET lane total (664) as separate evidence lanes.
    Counts are sourced from proof-packet v0.81 / docs/VALIDATION_LEDGER.md.
...
$psTotal = 2025  # = validation_summary.total_expected_assertions in proof-packet v0.81
...
Write-Output ""
Write-Output "  PowerShell lane  (validation_summary in proof-packet v0.81):"
...
Write-Output ""
Write-Output "  .NET lane  (dotnet_validation_summary in proof-packet v0.81 -- tracked separately):"
