...
<#
.SYNOPSIS
    Writes a deterministic local proof packet (v0.66) covering ImageMapForge,
...
$packet = [ordered]@{
    schema                  = 'pzmapforge.proof-packet.v0.66'
    ...
    validation_summary      = [ordered]@{
        ...
        map8q_igmb_structure_inspector_tests                      = 20
        ...
        total_expected_assertions         = 1494
    }
...
| MAP-8Q IGMB structure inspector tests | 20 |
