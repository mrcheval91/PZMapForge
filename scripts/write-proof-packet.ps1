...
<#
.SYNOPSIS
    Writes a deterministic local proof packet (v0.62) covering ImageMapForge,
...
$packet = [ordered]@{
    schema                  = 'pzmapforge.proof-packet.v0.62'
    ...
    validation_summary      = [ordered]@{
        ...
        map8m_worldmap_bin_presence_inspector_tests   = 15
        ...
        total_expected_assertions         = 1371
    }
...
| MAP-8M worldmap bin presence inspector tests | 15 |
