...
<#
.SYNOPSIS
    Writes a deterministic local proof packet (v0.83) covering ImageMapForge,
...
$packet = [ordered]@{
    schema                  = 'pzmapforge.proof-packet.v0.83'
    ...
    validation_summary      = [ordered]@{
        ...
        map38b_differential_control_test_packet_tests              = 65
        map37e_differential_control_test_packet_tests              = 60
        map37d_human_runtime_load_test_packet_tests                = 29
        map37c_chunkdata_staged_packet_tests                       = 20
        ...
        map8z_controlled_igmb_install_packet_tests                = 24
        map8y_experimental_igmb_writer_tests                      = 30
        map8y_experimental_igmb_writer_packet_tests               = 20
        ...
        map8u_first_non_ff_transition_inspector_tests             = 27
        map8u_first_non_ff_transition_result_tests                = 20
        map8t_real_cell_boundary_result_tests                     = 20
        map8s_igmb_cell_boundary_inspector_tests                  = 20
        map8s_cell_boundary_result_tests                          = 20
        map8r_real_igmb_structure_result_tests                    = 20
        map8q_igmb_structure_inspector_tests                      = 24
        map8q_igmb_structure_result_tests                         = 20
        map8p_igmb_header_result_tests                            = 20
        map8o_worldmap_bin_header_inspector_tests     = 22
        map8o_worldmap_bin_header_result_tests        = 20
        map8n_worldmap_bin_presence_result_tests      = 20
        map8m_worldmap_bin_presence_inspector_tests   = 16
        map8l_worldmap_xml_runtime_result_tests       = 20
        map8l_worldmap_xml_substantial_candidate_tests = 20
        map8k_parent_metadata_contract_comparator_tests = 20
        map8i_dual_spawnpoint_runtime_result_tests = 20
        map8h_parent_child_contract_probe_tests   = 20
        map8f_lots_self_runtime_result_tests      = 20
        map8d_no_invalid_worldmap_bin_probe_tests = 20
        ...
        total_expected_assertions         = 2150
    }
...
| MAP-8M worldmap bin presence inspector tests | 16 |
