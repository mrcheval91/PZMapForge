...
<#
.SYNOPSIS
    Writes a deterministic local proof packet (v0.53) covering ImageMapForge,
...
$packet = [ordered]@{
    schema                  = 'pzmapforge.proof-packet.v0.53'
    ...
    validation_summary      = [ordered]@{
        ...
        total_expected_assertions         = 1166
    }
...
Schema: pzmapforge.proof-packet.v0.34
