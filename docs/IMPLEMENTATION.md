...
| SVG large-file parse fix (SVG-2A) | Ratified | MaxCharactersInDocument raised 10M→50M; parse_status/parse_error/max_characters_in_document added to structure JSON; failures recorded with error message not swallowed; 4 new tests (parse_status, "parsed" value, empty parse_error, max_characters field); total 271 tests |
